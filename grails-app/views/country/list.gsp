			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="iso2digitCode" title="${message(code: 'country.iso2digitCode.label', default: 'Iso2digit Code')}" />
					
						<g:sortableColumn property="iso3digitCode" title="${message(code: 'country.iso3digitCode.label', default: 'Iso3digit Code')}" />
				...
				<g:each in="${countryInstanceList}" status="i" var="countryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: countryInstance, field: "iso2digitCode")}</td>
					
						<td>${fieldValue(bean: countryInstance, field: "iso3digitCode")}</td>
